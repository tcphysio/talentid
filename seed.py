...
SAMPLES = [
    dict(
        ...
        current_citizenship="Italian", aire_number="", codice_fiscale="Yes",
        visa_status="EU/Italian citizen",
    ...
    dict(
        ...
        italian_parent_or_grandparent="Yes", years_resident_in_italy="0",
        current_citizenship="Nigerian, British", aire_number="AIRE-LON-2023-00841", codice_fiscale="",
        visa_status="Non-EU — visa currently held",
